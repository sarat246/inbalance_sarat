...
function custom_post_example() { 
	...
	register_post_type( 'testimonials', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			'name' => __('Testimonials', 'post type general name'), /* This is the Title of the Group */
			'singular_name' => __('Testimonial', 'post type singular name'), /* This is the individual type */
			'add_new' => __('Add Testimonial', 'custom post type item'), /* The add new menu item */
			'add_new_item' => __('Add Testimonial'), /* Add New Display Title */
			'edit' => __( 'Edit' ), /* Edit Dialog */
			'edit_item' => __('Edit Testimonials'), /* Edit Display Title */
			'new_item' => __('New Testimonial'), /* New Display Title */
			'view_item' => __('View Testimonials'), /* View Display Title */
			'search_items' => __('Search Testimonials'), /* Search Custom Type Title */ 
			'not_found' =>  __('Nothing found in the Database.'), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __('Nothing found in Trash'), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is the section for "writing for" client testimonials' ), /* Custom Type Description */
			'public' => true,
